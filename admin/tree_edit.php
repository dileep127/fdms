...
?>
        ...
        <center>
		<?php include('val.php');?>
            <form id="formID" action="tree_update.php" method="post">
			    ...
			    <table width="1006" height="571" border="0" align="center">
                    ...
                    <tr>
                        <th>IMAGE</th>
                        <td><input type="file" id="tree_photo" name="tree_photo" value="<?php echo $row['tree_photo'];?>" class="form-control" ></td>
                    </tr>
