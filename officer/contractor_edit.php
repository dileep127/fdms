...
?>
		...
		<?php include('val.php');?>
            <form id="formID" action="contractor_update.php" method="post">
               ...
               <tr>
                        <th> CONTRACTOR ID</th>
                        <td><input type="text" id="contractor_id" name="contractor_id" value="<?php echo $row['contractor_id'];?>" class="form-control" ></td>
                    </tr>
                    ...
                    <tr>
                        <th>CITY</th>
                        <td><input type="text" id="contractor_city" name="contractor_city" value="<?php echo $row['contractor_city'];?>" class="form-control"></td>
                    </tr>
                    <tr>
                        <th>EMAIL</th>
					 ...
					 <tr>
                        ...
                        <td><input type="text" id="contractor_contact" name="contractor_contact" value="<?php echo $row['contractor_contact'];?>" class="validate[required] form-control"></td>
                    </tr>
