...
?>						
		...
		<?php include('val.php');?>
			...
			<table width="423" height="352" border="0" align="center">
               <tr>
                        <th>SALE ID</th>
                        <td><input type="text" id="sales_id" name="sales_id" value="<?php echo $row['sales_id'];?>" class="form-control"></td>
                  </tr>
	  ...
	  ?>
                    ...
                    <tr>
                        <th>SALE DATE</th>
                        <td><input type="date" id="sale_date" name="sale_date" value="<?php echo $row['sale_date'];?>" class="validate[required,custom[date]] form-control"></td>
                    </tr>
