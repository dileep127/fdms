	...
	<div class="left main-sidebar">
		...
		<div class="sidebar-inner leftscroll">
			...
			<ul>
					...
					<!-- <li class="submenu">
						<a href="home.php"><i class="fa fa-fw fa-bars"></i><span> Dashboard </span> </a>
                    </li> -->
					
					<li class="submenu">
                        <a href="dept_view.php"><i class="fa fa-fw fa-area-chart"></i><span>Department Details</span> </a>
                    </li>
					<li class="submenu">
                        <a href="raw_view.php"><i class="fa fa-fw fa-area-chart"></i><span>Raw Material Details</span> </a>
                    </li>
					<li class="submenu">
                        <a href="vendor_view.php"><i class="fa fa-fw fa-area-chart"></i><span>Vendor Details</span> </a>
                    </li>
					
					<li class="submenu">
                        <a href="vendor_order_view.php"><i class="fa fa-fw fa-area-chart"></i><span>Raw Material Orders</span> </a>
                    </li>
					<li class="submenu">
                        <a href="product_view.php"><i class="fa fa-fw fa-area-chart"></i><span>Product Details</span> </a>
                    </li>
					
					<li class="submenu">
                        <a href="production_view.php"><i class="fa fa-fw fa-area-chart"></i><span>Production Details</span> </a>
                    </li>
					
					<li class="submenu">
                        <a href="stock_view.php"><i class="fa fa-fw fa-area-chart"></i><span>Stock Details</span> </a>
                    </li>
					
					
					
					<li class="submenu">
                        <a href="distributor_view.php"><i class="fa fa-fw fa-area-chart"></i><span>Distributor Details</span> </a>
                    </li>
					
					<li class="submenu">
                        <a href="distributor_bill_master_view.php"><i class="fa fa-fw fa-area-chart"></i><span>Disributor Bill Details</span> </a>
                    </li>
					...
					<li class="submenu">
                        <a href="emp_view.php"><i class="fa fa-fw fa-area-chart"></i><span>Employee Details</span> </a>
                    </li>
					
						<li class="submenu">
                        <a href="attendance_view.php"><i class="fa fa-fw fa-area-chart"></i><span> Attendance Details </span> </a>
                    </li>
					
					<li class="submenu">
                        <a href="emp_sal_view.php"><i class="fa fa-fw fa-area-chart"></i><span>Emp Salary Details</span> </a>
                    </li>
					
				
					
					<li class="submenu">
                        <a href="change_password.php"><i class="fa fa-fw fa-area-chart"></i><span>Change Password</span> </a>
                    </li>
					
					
					<li class="submenu">
                        <a href="../logout.php"><i class="fa fa-fw fa-area-chart"></i><span>Logout</span> </a>
                    </li>
